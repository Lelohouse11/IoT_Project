...
- **Map Data REST API (FastAPI + InfluxDB)** – `api/map_data_api.py` exposes `/api/accidents/recent` and `/api/parking/recent`, querying Influx for the latest active accidents and parking data used by the frontend.
