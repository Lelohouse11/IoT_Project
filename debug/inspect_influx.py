"""
Script: inspect_influx.py
Description: Utility script to inspect the InfluxDB schema and data.
             Allows listing buckets, measurements, fields, and tag keys.
             Useful for debugging data ingestion and storage.
"""
...
def list_measurements():
    """
    List all measurements in the configured InfluxDB bucket.
    """
    query = f'''
...
def list_fields(measurement):
    """
    List all field keys for a specific measurement.
    
    Args:
        measurement (str): The name of the measurement to inspect.
    """
    query = f'''
    import "influxdata/influxdb/schema"
...
def list_tag_keys(measurement):
    """
    List all tag keys for a specific measurement.
